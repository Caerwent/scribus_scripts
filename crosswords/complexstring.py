...
class ComplexString(str):
    ...
    @staticmethod
    def _check_bzh(word):
        formatted = word.replace(ComplexString.bzh_chars[0][0], ComplexString.bzh_chars[0][1])
        formatted = formatted.replace(ComplexString.bzh_chars[1][0], ComplexString.bzh_chars[1][1])
        return formatted
